...
// Text
$_['text_success']           = 'Товар <a href="%s" style="display:none"></a> %s  добавлен в корзину покупок!';
...
$_['error_text'] = 'Проверьте введенные данные';

$_['text_mail_subj'] = 'Заявка на каталог';
$_['text_mail_msg'] = "Заявка на каталог\n\nИмя: %s\n\nТелефон: %s\n\n Компания: %s\n\n Email: %s\n\n";

$_['text_mail_success'] = 'Спасибо заявка отправлена';
?>