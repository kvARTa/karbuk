...
class ControllerCheckoutSimpleCheckoutCart extends Controller { 
    ...
    public function index() {
        ...
        //dymm вес = 0
        $cart_weight = 0;//$this->cart->getWeight();
        ...
        //dymm вес = 0
        if ($this->data['simple_show_weight'] && false) {
            $this->data['weight'] = 0;//$this->weight->format($this->cart->getWeight(), $this->config->get('config_weight_class_id'), $this->language->get('decimal_point'), $this->language->get('thousand_point'));
        }
