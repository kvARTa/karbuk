  ...
  <div class="box-content">
    <form id="filters">
      <?php foreach ($category_options as $category_option) { ?>
        <b style="color:#bd080e"><?php echo $category_option['name']; ?></b>
