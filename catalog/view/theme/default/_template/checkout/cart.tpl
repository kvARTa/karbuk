...
<?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <table id="total">
      ...
      <tr>
        <td width="660" class="right" ><b style="color:#000; "><?php echo $total['title']; ?>:</b></td>
  ...
  <div class="buttons cart">
    <div class="left"><a href="<?php echo $checkout; ?>" class="button2"><?php echo $button_checkout; ?></a></div>
...
<table  border="0" class="tovar_in_cart_tb">
  <tr>
    <td class="tovar_in_cart_tb_left"> 
        <form action="" method="post" enctype="multipart/form-data">
         <input name="tover_in_cart" type="text" class="input cart" />
       </form>
       </td>
    <td class="tovar_in_cart_tb_right"> 
   
       <a href="#" class="button grey"></a>
        </td>
  </tr>
</table>
  ...
  <div class="line1">
     ...
     <a href="#" > Сохранить корзину в файл (формат Excel)</a>
      ...
      <div class="left">
        ...
        <div class="center">
     <a href="#" >Заказать каталог товаров “Карбук”</a>
        </div>
        </div>
