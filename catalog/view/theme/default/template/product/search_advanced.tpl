...
<div class="product-filter">
    ...
    <div class="limit sa-limit"><b><?php echo $text_limit; ?></b>


     <select onchange="location = this.value;">
    <?php foreach ($limits as $limits1) { ?>
    <?php if ($limits1['value'] == $limit) { ?>
    <option value="<?php echo $limits1['href']; ?>" selected="selected"><?php echo $limits1['text']; ?></option>
    <?php } else { ?>
    <option value="<?php echo $limits1['href']; ?>"><?php echo $limits1['text']; ?></option>
    <?php } ?>
    <?php } ?>
   </select>
    ...
    <div class="sort sa-sort"><b><?php echo $text_sort; ?></b>
   ...
   <select onchange="location = this.value;">
    ...
    <option value="<?php echo $sorts1['href']; ?>" selected="selected"><?php echo $sorts1['text']; ?></option>
    <?php } else { ?>
    <option value="<?php echo $sorts1['href']; ?>"><?php echo $sorts1['text']; ?></option>
    <?php } ?>
    <?php } ?>
   </select>
