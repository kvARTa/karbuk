...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['email_feedback'])) {
			$this->data['error_email_feedback'] = $this->error['email_feedback'];
		} else {
			$this->data['error_email_feedback'] = '';
		}
		...
		if (isset($this->request->post['config_email_feedback'])) {
			$this->data['config_email_feedback'] = $this->request->post['config_email_feedback'];
		} else {
			$this->data['config_email_feedback'] = $this->config->get('config_email_feedback');
		}
	...
	private function validate() {
    	...
    	if ((utf8_strlen($this->request->post['config_email_feedback']) > 96) || !preg_match('/^[^\@]+@.*\.[a-z]{2,6}$/i', $this->request->post['config_email_feedback'])) {
      		$this->error['email_feedback'] = 'Не корректный email';
    	}
