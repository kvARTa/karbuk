...
class ControllerCatalogProduct extends Controller {
	private $error = array(); 
  	...
  	private function getForm() {
		...
		$this->data['entry_multiplicity'] = $this->language->get('entry_multiplicity');
		...
		if (isset($this->request->post['multiplicity'])) {
			$this->data['multiplicity'] = $this->request->post['multiplicity'];
		} elseif (!empty($product_info)) {
			$this->data['multiplicity'] = $product_info['multiplicity'];
		} else {
			$this->data['multiplicity'] = 1;
		}
