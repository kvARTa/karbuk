          ...
          <div id="tab-address-<?php echo $address_row; ?>" class="vtabs-content">
		    ...
		    <select name="address[<?php echo $address_row; ?>][zone_id]">
              ...
              <tr>
                ...
                <td><input type="text" name="address[<?php echo $address_row; ?>][city]" value="<?php echo $address['city']; ?>" /></td>
              </tr>
              <tr>
                <td><?php echo $entry_address_1; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][address_1]" value="<?php echo $address['address_1']; ?>" /></td>
              </tr>
              <tr>
...
function country(element, index, zone_id) {
	$.ajax({
		url: 'index.php?route=sale/customer/country&token=<?php echo $token; ?>&country_id=176',
		dataType: 'json',
		beforeSend: function() {
...
function addAddress() {	
    ...
    html += '         <option value="176"><?php echo $text_select; ?></option>';
    html += '      </select></td>';
    html += '    </tr>';
	html += '    <tr>';
