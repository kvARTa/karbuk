    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-option">
          ...
          <table class="form">
              <tr>
                  <td>Отключить товары без картинок :</td>
                  <td><?php if ($config_product_no_image) { ?>
                      <input type="radio" name="config_product_no_image" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="config_product_no_image" value="0" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_product_no_image" value="1" />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="config_product_no_image" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } ?></td>
              </tr>
            <tr>
          ...
          <table class="form">
            <tr>
              <td>Email для модуля "Отзывы и предложения"</td>
              <td><input type="text" name="config_email_feedback" value="<?php echo $config_email_feedback; ?>" />
                <?php if ($error_email_feedback) { ?>
                <span class="error"><?php echo $error_email_feedback; ?></span>
                <?php } ?></td>
            </tr>
          </table>
        </div>
