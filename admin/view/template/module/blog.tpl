      ...
      <table id="module" class="list">
        <thead>
          <tr>
            ...
            <td class="left"><?php echo $entry_blog; ?></td>
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            ...
            <td class="left"><select name="blog_module[<?php echo $module_row; ?>][blog_id]">
                <?php foreach ($blogs_select as $blogs_option) { ?>
                <?php if ($blogs_option['blog_id'] == $module['blog_id']) { ?>
                <option value="<?php echo $blogs_option['blog_id']; ?>" selected="selected"><?php echo $blogs_option['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $blogs_option['blog_id']; ?>"><?php echo $blogs_option['name']; ?></option>
                <?php } ?>
                <?php } ?>
              </select></td>  
